...
export default async function InvitePage({ params }: InvitePageProp) {
  ...
  return (
    <div className="flex min-h-screen animate-opacity flex-col items-center justify-center px-4">
